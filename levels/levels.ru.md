...
В файловой структуре проекта уровень переопределния выглядит как группирующая директория, которая содержит исходныt файлs реализаций [БЭМ-сущностей](https://ru.bem.info/methodology/key-concepts/#БЭМ-сущность). 
