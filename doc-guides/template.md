...
Блок предоставляет
        ...
        объект события, даполненый набором методов (свойств) для ...
...
| Метод | Описание |
| ----- | -------- |
| <a href="#methods-method">Название метода</a> (<i>якорь на соответствующий заголовок</i>)  Краткое описание. |
...
### Публичные методы элементов блока

| Элемент | Метод | Описание |
| ------- | ----- | -------- |
| Название элемента, к которому относится метод | <a href="#якорь40">Название поля</a> (<i>якорь на соответствующий заголовок</i>) | Краткое описание. |
...
<Взаимосвязь методов. Смысловые гркппировки.>

<a name="methods-method"></a>
