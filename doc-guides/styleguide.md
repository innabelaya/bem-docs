...
* Корректное отображение информации при парсинге документа в формате `Markdown` в HTML-представление.
...
* Предоставляя читателю дополнительную инфрмацию, необходимо ссылаться на bem.info/lego, а не на Github.
